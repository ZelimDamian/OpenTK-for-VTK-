...
namespace VTKInt.Framebuffers
{
    public class FramebufferCreator 
    {
        ...
        {
            defaultFb = new DefaultFramebuffer(new Vector2(SceneManager.Window.Width, SceneManager.Window.Height), this);
        }
...
//    }
//
//    public class CubemapBufferSets 
//    {
...
//    }
    ...
    public class Framebuffer 
    {
        ...
        public OpenTK.Graphics.Color4 clearColor = new OpenTK.Graphics.Color4(0f, 0f, 0f, 0f);
